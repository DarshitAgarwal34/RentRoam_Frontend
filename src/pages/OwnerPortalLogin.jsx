      ...
      <div className="w-full max-w-4xl">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
          ...
          >
            ...
            <h3 className="mt-4 text-2xl md:text-3xl font-extrabold">Owner login</h3>
            <p className="mt-2 text-sm md:text-base text-white/90 max-w-xs">
              Manage listings, bookings, and owner dashboard actions from your dedicated portal.
            </p>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Owner portal</div>
                </div>
              </div>
              <Link to="/login" className="text-sm text-rr-orange hover:underline">
                Customer login
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="owner@rentroam.com"
              ...
              <div className="relative">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <Link to="/forgot-password?role=owner" className="text-sm text-rr-orange hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <input
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm text-gray-600">
                  Need an account? <Link to="/signup" className="text-rr-orange hover:underline">Sign up</Link>
                </div>
              </div>
            </form>
          </div>
